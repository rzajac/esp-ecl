 ...
 */
typedef void (*nm_err_cb)(nm_tcp* conn, sint8 err, sint16 err_sdk);

// The receive data callback prototype.
typedef void (*nm_rcv_cb)(nm_tcp* conn, uint8_t *data, size_t len);

// The send data callback prototype.
typedef void (*nm_cb)(nm_tcp *conn);
